  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "days_expression": parse_days_expression
      };
      ...
      function parse_metric_primary_expression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, reduce, event) { event.reduce = reduce; event.source = input.substring(pos1, pos); return event; })(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_days_expression() {
        var result0, result1, result2;
        var pos0, pos1;
        
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 5) === "days[") {
          result0 = "days[";
          pos += 5;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          ...
          return new Date(new Date().getTime() + (a*60*60*24*1000));
         })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
